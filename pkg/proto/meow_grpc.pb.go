...
type MeowServiceClient interface {
	Create(ctx context.Context, in *CreateMeowRequest, opts ...grpc.CallOption) (*CreateMeowResponse, error)
}
...
func (c *meowServiceClient) Create(ctx context.Context, in *CreateMeowRequest, opts ...grpc.CallOption) (*CreateMeowResponse, error) {
	out := new(CreateMeowResponse)
	err := c.cc.Invoke(ctx, "/proto.MeowService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MeowServiceServer interface {
	Create(context.Context, *CreateMeowRequest) (*CreateMeowResponse, error)
	mustEmbedUnimplementedMeowServiceServer()
}

// UnimplementedMeowServiceServer must be embedded to have forward compatible implementations.
type UnimplementedMeowServiceServer struct {
}

func (UnimplementedMeowServiceServer) Create(context.Context, *CreateMeowRequest) (*CreateMeowResponse, error) {
...
func _MeowService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateMeowRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MeowServiceServer).Create(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.MeowService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeowServiceServer).Create(ctx, req.(*CreateMeowRequest))
	}
...
var MeowService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.MeowService",
	HandlerType: (*MeowServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Create",
			Handler:    _MeowService_Create_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/proto/meow.proto",
}
